    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        for t in range(total_timesteps):
            ...
            if t > learning_starts and t % train_freq == 0:
                ...
                [td_error, q_t_selected, q_tp1_using_online_net, q_tp1_best_using_online_net, q_tp1_best, entropy, q_tp1_best_masked, q_t_selected_target, td_error, errors, pre_weighted_error, weighted_error] = train(obses_t, actions, rewards, obses_tp1, dones, weights)
